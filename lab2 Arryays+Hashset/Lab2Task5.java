    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (choice == 6) {
                ...
                System.out.print("Discount Code (don't have pleas 0): ");
                String code = in.next();
                if (coupon.contains(code)) {
                    System.out.print("Total price: " + (0.9*price[choice-1])+ "Bath");
                    coupon.remove(code);
                } 
                else {
                    System.out.println("Total price: " + (0.9*price[choice-1])+ "Bath");
                }
            }
        }
